...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ScLibraryAccessors laccForScLibraryAccessors = new ScLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>calls</b>
     */
    ...
    /**
     * Group of libraries at <b>sc</b>
     */
    public ScLibraryAccessors getSc() {
        return laccForScLibraryAccessors;
    }
    ...
    public static class CallsLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>sdk</b> with <b>com.calls.sdk:calls-sdk</b> coordinates and
         * with version reference <b>callsSdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSdk() {
            return create("calls.sdk");
        }

    }

    public static class ScLibraryAccessors extends SubDependencyFactory {

        public ScLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sdk</b> with <b>com.example.sc_sdk:sc-sdk</b> coordinates and
         * with version reference <b>scSDK</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSdk() {
            return create("sc.sdk");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>callsSdk</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCallsSdk() { return getVersion("callsSdk"); }
        ...
        /**
         * Version alias <b>scSDK</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getScSDK() { return getVersion("scSDK"); }
    ...
    public static class AgpVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>agp.library</b> with value <b>8.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLibrary() { return getVersion("agp.library"); }
    ...
    public static class AndroidPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>agp.library</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
